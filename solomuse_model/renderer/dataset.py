...
class RendererDataset(Dataset):
    ...
    def __init__(self, manifest_path: str, split: str = "train", val_ratio: float = 0.1):
        ...
        if "split" not in df.columns:
            raise ValueError(f"FATAL: Manifest {manifest_path} lacks a 'split' column! You must use `manifest_renderer_splits.csv` generated by `solomuse_model.utils.splits.create_track_grouped_splits` to prevent data leakage.")
